        ...
        <div className="mx-auto lg:col-span-9 w-full p-6">
          <div className="grid py-4 mx-auto gap-8 md:grid-cols-12">
            <div className="mx-auto md:col-span-4 w-full p-6">
              ...
              />
              <p className="font-light sm:text-xl">4 SUI <Image className="inline" height={20} src={SUILogo} alt="" /></p>
              <CommonButton
                ...
                isLoading={isLoading && selectedBG === "starter"}
              >
                Buy Pack
              </CommonButton>
            </div>
            <div className="mx-auto md:col-span-4 w-full p-6">
              <Image
                ...
                className="w-full border border-gray-400"
              />
              <p className="font-light sm:text-xl">7 SUI <Image className="inline" height={20} src={SUILogo} alt="" /></p>
              <CommonButton
                onClick={handleJumbo}
                className={
                  "hover:bg-[#4abd6a] hover:text-white border border-black border-b-2 border-r-2 bg-white hover:border-black uppercase text-2xl px-5 py-2.5 text-center h-fit min-w-fit m-2"
                }
                isLoading={isLoading && selectedBG === "jumbo"}
              >
                Buy Pack
              </CommonButton>
            </div>
